...
class MemoryConfigGUI:
    def __init__(self, root, memory_size=1024):
        self.root = root
        self.root.title("Memory Configuration GUI")
        ...
        for i in range(memory_size):
            label = ttk.Label(self.scrollable_frame, text=f"Mem[{i}]:")
...
if __name__ == "__main__":
    root = tk.Tk()
    gui = MemoryConfigGUI(root, memory_size=1024)
    root.mainloop()
